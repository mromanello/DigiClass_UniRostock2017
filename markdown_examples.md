...
**MacDown** is created as a simple-to-use editor for Markdown documents. I render your Markdown contents real-time into HTML, and display them in a preview panel, like this:

```
![MacDown Screenshot](macdown_screenshot.png)
```
